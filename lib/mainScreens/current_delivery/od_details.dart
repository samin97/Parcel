...
import 'package:user_app/mainScreens/current_delivery/ongoing_delivery.dart';
...
class ODDetails extends StatefulWidget {
  ...
  ODDetails({required this.documentID});

  @override
  State<ODDetails> createState() => _ODDetailsState();
}
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Route newRoute = MaterialPageRoute(builder: (_) => OngoingDelivery());
                ...
                : SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        ElevatedButton(
                          child: const Text('Conform parcel delivered'),
                          onPressed: () {
