...
class AcceptRider extends StatefulWidget {
  @override
  _AcceptRiderState createState() => _AcceptRiderState();
}

class _AcceptRiderState extends State<AcceptRider> {
      ...
      body: SingleChildScrollView(
        child: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance
                ...
                .where('riderCompleted', isEqualTo: false)
