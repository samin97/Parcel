...
import 'ac_details.dart';

class ARCard extends StatefulWidget {
  final Order model;
  ...
  @override
  _ARCardState createState() => _ARCardState();
}
class _ARCardState extends State<ARCard> {
  @override
